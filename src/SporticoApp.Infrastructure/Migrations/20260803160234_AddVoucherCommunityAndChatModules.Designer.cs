...
namespace SporticoApp.Infrastructure.Migrations
{
    ...
    [Migration("20260803160234_AddVoucherCommunityAndChatModules")]
    partial class AddVoucherCommunityAndChatModules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SporticoApp.Core.Entities.ApiRequestMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("api_request_metrics_pkey");

                    b.HasIndex(new[] { "Path" }, "idx_api_request_metrics_path");

                    b.HasIndex(new[] { "RequestedAt" }, "idx_api_request_metrics_requested_at")
                        .IsDescending();

                    b.HasIndex(new[] { "VisitorSessionId" }, "idx_api_request_metrics_session");

                    b.HasIndex(new[] { "UserId" }, "idx_api_request_metrics_user");

                    b.ToTable("api_request_metrics", null, t =>
                        {
                            t.HasComment("One tracked backend API request within a visitor session");
                        });
                });
            ...
            modelBuilder.Entity("SporticoApp.Core.Entities.PageView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("page_views_pkey");

                    b.HasIndex(new[] { "Path" }, "idx_page_views_path");

                    b.HasIndex(new[] { "VisitorSessionId" }, "idx_page_views_session");

                    b.HasIndex(new[] { "UserId" }, "idx_page_views_user");

                    b.HasIndex(new[] { "ViewedAt" }, "idx_page_views_viewed_at")
                        .IsDescending();

                    b.ToTable("page_views", null, t =>
                        {
                            t.HasComment("Frontend navigation event submitted by the client, within a visitor session");
                        });
                });
            ...
            modelBuilder.Entity("SporticoApp.Core.Entities.VisitorSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("visitor_sessions_pkey");

                    b.HasIndex(new[] { "Browser" }, "idx_visitor_sessions_browser");

                    b.HasIndex(new[] { "Country" }, "idx_visitor_sessions_country");

                    b.HasIndex(new[] { "Device" }, "idx_visitor_sessions_device");

                    b.HasIndex(new[] { "FirstSeenAt" }, "idx_visitor_sessions_first_seen")
                        .IsDescending();

                    b.HasIndex(new[] { "LastSeenAt" }, "idx_visitor_sessions_last_seen")
                        .IsDescending();

                    b.HasIndex(new[] { "UserId" }, "idx_visitor_sessions_user");

                    b.HasIndex(new[] { "VisitorId", "LastSeenAt" }, "idx_visitor_sessions_visitor_last_seen");

                    b.ToTable("visitor_sessions", null, t =>
                        {
                            t.HasComment("One browsing session by an anonymous or logged-in visitor");
                        });
                });
            ...
            modelBuilder.Entity("SporticoApp.Core.Entities.ApiRequestMetric", b =>
                {
                    ...
                    b.HasOne("SporticoApp.Core.Entities.VisitorSession", "VisitorSession")
                        .WithMany("ApiRequestMetrics")
