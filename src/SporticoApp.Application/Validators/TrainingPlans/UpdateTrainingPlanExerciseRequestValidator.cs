...
{
    public class UpdateTrainingPlanExerciseRequestValidator
        : AbstractValidator<UpdateTrainingPlanExerciseRequest>
    {
        public UpdateTrainingPlanExerciseRequestValidator()
        {
