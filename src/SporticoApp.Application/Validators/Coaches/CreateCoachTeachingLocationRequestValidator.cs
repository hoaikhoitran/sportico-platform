...
{
    public class CreateCoachTeachingLocationRequestValidator : AbstractValidator<CreateCoachTeachingLocationRequest>
    {
        public CreateCoachTeachingLocationRequestValidator()
        {
            RuleFor(x => x.Address)
                .NotEmpty()
